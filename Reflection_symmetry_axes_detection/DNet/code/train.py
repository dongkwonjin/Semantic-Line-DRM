...
class Train_Process_DNet(object):
    ...
    def validation(self):
        ...
        self.val_result['AUC_A_upper_R_0.98'] = save_model_max_upper(self.ckpt, self.cfg.weight_dir,
                                                                     self.val_result['AUC_A_upper_R_0.98'], auc_a, auc_r, 0.98,
                                                                     logger, self.logfile, 'AUC_A_upper_R_0.98')
        self.val_result['AUC_A_upper_P_0.96'] = save_model_max_upper(self.ckpt, self.cfg.weight_dir,
                                                                     self.val_result['AUC_A_upper_R_0.96'], auc_a, auc_r, 0.96,
                                                                     logger, self.logfile, 'AUC_A_upper_R_0.96')
